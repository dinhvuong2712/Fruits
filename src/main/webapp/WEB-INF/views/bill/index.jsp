        ...
        <tr class="dataTable-container">
            ...
            <table id="employee-all" class="table table-sm table-hover table-striped">
                ...
                <c:forEach var="item" items="${items}">
                    <tr>
                        <td><span class="user-select-none">#&nbsp;</span>${item.id_bill}</td>
                        <td>${item.firstName} ${item.id_customer}</td>
                        <td class="gender">${item.id_emp}</td>
                        <td><span>0</span>${item.total_acount}</td>
                        <td <c:choose>
