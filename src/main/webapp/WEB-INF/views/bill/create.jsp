...
<div class="row justify-content-center">
    <div class="col-lg-10">
        <div class="card shadow-lg border-0 rounded-lg mt-5">
            ...
            <div class="card-body">
                <form id="target" method="post" action="/admin/bill/addConfirmed">
                    <input type="hidden" name="Id_emp" value="0">
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="small mb-1" for="Id_emp">First Name</label>
                                <input class="form-control py-2" name="FirstName" id="Id_emp" type="text" aria-describedby="nameHelp" placeholder="Enter First Name">
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="small mb-1" for="Id_customer">Last Name</label>
                                <input class="form-control py-2" name="LastName" id="Id_customer" type="text" aria-describedby="nameHelp" placeholder="Enter Last Name">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
