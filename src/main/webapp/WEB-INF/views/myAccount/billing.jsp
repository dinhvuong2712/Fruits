    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-tabs w-100" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" href="/myAccount/billing">Billing</a>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="billing" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="container-xl px-0 mt-4">
                        <div class="row">
                            <div class="col-lg-4 mb-4">
                                <!-- Billing card 1-->
                                <div
                                        class="card h-100 border-0 border-start border-primary border-5 shadow">
                                    <div class="card-body">
                                        <div class="fs-6 text-gray-500">Current monthly bill</div>
                            ...
                            <div class="col-lg-4 mb-4">
                                ...
                                <div
                                        class="card h-100 border-0 border-start border-primary border-5 shadow">
                                    <div class="card-body">
                                        <div class="fs-6 text-gray-500">Next payment due</div>
                            ...
                            <div class="col-lg-4 mb-4">
                                ...
                                <div
                                        class="card h-100 border-0 border-start border-primary border-5 shadow">
                                    <div class="card-body">
                                        <div class="fs-6 text-gray-500">Current plan</div>
                            ...
                            <div class="card-body px-0">
                                ...
                                <div class="d-flex align-items-center justify-content-between px-4">
                                    <div class="d-flex align-items-center">
                                        <svg class="svg-inline--fa fa-cc-visa fa-w-18 fa-2x cc-color-visa"
                                             aria-hidden="true" focusable="false" data-prefix="fab"
                                             data-icon="cc-visa" role="img"
                                        ...
                                        <!-- <i class="fab fa-cc-visa fa-2x cc-color-visa"></i> Font Awesome fontawesome.com -->
                                        <div class="ms-4">
                                ...
                                <div class="d-flex align-items-center justify-content-between px-4">
                                    <div class="d-flex align-items-center">
                                        <svg class="svg-inline--fa fa-cc-mastercard fa-w-18 fa-2x cc-color-mastercard"
                                             aria-hidden="true" focusable="false" data-prefix="fab"
                                             data-icon="cc-mastercard" role="img"
                                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
                                             data-fa-i2svg="">
                                            <path fill="currentColor"
                                        ...
                                        <!-- <i class="fab fa-cc-mastercard fa-2x cc-color-mastercard"></i> Font Awesome fontawesome.com -->
                                        <div class="ms-4">
                                ...
                                <div class="d-flex align-items-center justify-content-between px-4">
                                    <div class="d-flex align-items-center">
                                        <svg class="svg-inline--fa fa-cc-amex fa-w-18 fa-2x cc-color-amex"
                                             aria-hidden="true" focusable="false" data-prefix="fab"
                                             data-icon="cc-amex" role="img"
                                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
                                             data-fa-i2svg="">
                                            <path fill="currentColor"
                                        ...
                                        <!-- <i class="fab fa-cc-amex fa-2x cc-color-amex"></i> Font Awesome fontawesome.com -->
                                        <div class="ms-4">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="table-responsive table-billing-history">
                                    <table class="table mb-0">
                                        <thead>
                                        <tr>
                                            <th class="border-gray-200" scope="col">Transaction ID
                                            </th>
