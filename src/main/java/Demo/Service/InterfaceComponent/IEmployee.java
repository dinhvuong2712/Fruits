...
public interface IEmployee extends ICommonService<Employee, EmployeeViewModel>, IPaginationService<EmployeeViewModel>{
    @Override
    ...
    @Override
    List<EmployeeViewModel> selectByPage(int pageNumber,int pageSize,String keyword);
}
